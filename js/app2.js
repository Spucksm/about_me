...
function question2() {
  ...
  if (home === "yes" || home === "y") {
    ...
    alert(
      "I didn't understand your answer. Make sure your responses are yes or no only."
    );
  }
  console.log(home);
}
...
function question3() {
  ...
  if (color === "yes" || color === "y") {
    alert(
      "Correct! My favorite color is green! I wonder what your favorite color is."
    );
    guessScore++;
    ...
    alert(
      "I didn't understand your response. I can only understand yes or no responses at this time."
    );
  }
  console.log(color);
}
...
function question4() {
  ...
  if (sport === "yes" || sport === "y") {
    ...
    alert(
      "Wrong, its like you don't even know me! Soccer is my favorite sport."
    );
  } else {
    alert(
      "I didn't get that. Plaese answer these questions with a yes or no only."
    );
  }
  console.log(sport);
}
...
function question5() {
  ...
  if (coding === "no" || coding === "n") {
    alert(
      "You did it! you got it right. I think I am terrible at coding right now!"
    );
    guessScore++;
  } else if (coding === "yes" || coding === "y") {
    alert(
      "I think you may have higher regard for my skills than I do right now."
    );
  } else {
...
function numberGuess() {
  ...
  for (let i = 0; i < guessAttempts; i++) {
    ...
    while (questionSix < 1 || questionSix > 100) {
      questionSix = parseInt(
        prompt("Wrong range. Please enter a number 1- 100")
      );
    }
    ...
    if (i === guessAttempts - 1) {
      alert(
        "You did not guess correctly. The correct answer is " + correctNumber
      );
    }
  }
}
...
function favoritePasta() {
  ...
  while (i < guessAmount) {
    let pastaGuess = prompt("Can you guess one of my favorite types of Pasta?");
    console.log(
      userName + " guessed that one of my favorite pasta dishes is ",
      pastaGuess
    );
    for (let j = 0; j < pastaArray.length; j++) {
      if (pastaGuess === pastaArray[j]) {
        alert(
          "Nice! you guessed correctly! I really like " +
            pastaGuess +
...
alert(
  userName +
    ", thank you for taking my quiz. My name is Spenser, I don't like fish, even though I live in Washington, my favorite color is green, my favorite sport is soccer, go Sounders! Lastly, I don't think I am very good at coding yet. I know I still have a lot to learn. You answered " +
    guessScore +
    " questions correctly."
);
